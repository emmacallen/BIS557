...
#' @details This code was adapted from "A Computational Approach to Statistical Learning", Professor Kane's lecture materials, with the aid of Will Duke, and a collaoration with Christina Harden.
#'
